...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO users (name, email, age, profile_completed, child_mode) VALUES (?, ?, ?, ?, ?)");
        $stmt->execute([$name, $email, $age, $profile_completed, $child_mode]);
...
<head>
    ...
    <title>NutriCare - Add User</title>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="profile_completed" name="profile_completed">
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="child_mode" name="child_mode">
